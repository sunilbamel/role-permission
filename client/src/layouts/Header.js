...
export default function Header() {
    ...
    return (
        <div className="header-main px-3 px-lg-4">
            ...
            <Dropdown className="dropdown-skin ms-auto" align="end">
            ...
            <Dropdown className="dropdown-profile ms-3 ms-xl-4" align="end">
                ...
                <Dropdown.Menu className="mt-10-f">
                    <div className="dropdown-menu-body">
                        ...
                        <h5 className="mb-1 text-dark fw-semibold">{state && state?.name}</h5>
                        ...
                        <nav className="nav">
                            ...
                            <a type="button" href=" " onClick={logout} className="mt-3"><i className="ri-logout-box-r-line"></i>Log Out</a>
                        </nav>
                    </div>
                </Dropdown.Menu>
            </Dropdown>
